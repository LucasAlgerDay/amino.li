...
class SubClient(client.Client):
    ...
    def post_blog(self, title: str, content: str, imageList: list = None, captionList: list = None, categoriesList: list = None, backgroundColor: str = None, fansOnly: bool = False, extensions: dict = None, crash: bool = False, code: list = None):
        mediaList = []

        if captionList is not None and code is not None:
    ...
    def full_embed(self, link: str, image: BinaryIO, message: str, chatId: str, replyTo: str = None, mentionUserIds: list = None):
    ...
    def promote_rank(self, userId: str, rank: str):
